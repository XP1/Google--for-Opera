...
// @version 1.04
// @description Injects the missing HTML, CSS, and JavaScript code into Google+, which will show the web toolbar buttons and may, by the addition of more JavaScript, increase usability or the number of features.
// @author XP1
...
(function (opera, topWindow)
{
    ...
    var locale = (function ()
    {
        ...
        var publicMembers =
        {
            findNotificationText: function ()
            {
                ...
                {
                    notificationText = topWindowDocument.querySelector("a[href$=\"/notifications/all\"]").innerHTML; // Find notification text from the left sidebar link.
                });
            },
            ...
            findShareText: function ()
            {
                handleException(function ()
                {
                    shareText = topWindowDocument.querySelector("span.a-j.Oh[role=\"button\"]").innerHTML; // Find share text from the share links on the posts of the stream.
                });
            },
    ...
    var user = (function ()
    {
        ...
        var publicMembers =
        {
            ...
            findAvatarLink: function ()
            {
                handleException(function ()
                {
                    avatarLink = topWindow.OZ_initData["2"][1][3] + "?sz=48"; // Find the avatar link from the data arrays and then limit avatar size to 48x48 pixels.
                });
            },
    ...
    var injectJs = function (userJsEvent)
    {
        var element = userJsEvent.element;
        var elementText = element.text;
        if (element.src.length === 0 && (elementText.length >= 8000 && elementText.length <= 9000) && elementText.indexOf("window.jstiming.load.tick('ogjl');") !== -1)
        {
            locale.findNotificationText();
            locale.findShareText();
            locale.findLanguage(elementText);

            user.findNumber(elementText);
            user.findData(elementText);
            ...
            var js = "(function(){try{var d=true,i=false;var l=window.gbar=window.gbar||{};function _tvn(a,b){var c=parseInt(a,10);return isNaN(c)?b:c}function _tvf(a,b){var c=parseFloat(a);return isNaN(c)?b:c}function _tvb(a,b){return a==\"true\"?d:a==\"false\"?i:b}function _tvv(a){return!!a}function n(a,b,c){(c||l)[a]=b}l.bv={n:_tvn(\"2\",0),r:\"\",m:_tvn(\"1\",1)};var aa=function(){return l.bv.m==1};n(\"sb\",aa);"
                ...
                + "function _mlToken(a,b){try{if(G<1){G++;var c,e=a,f=b||{},g=encodeURIComponent,h=[\"//www.google.com/gen_204?atyp=i&zx=\",(new Date).getTime(),\"&jexpid=\",g(\"30315\"),\"&srcpg=\",g(\"prop=119\"),\"&jsr=\",Math.round(1/F),\"&ogv=\",g(\"1314760973.1314123632\")];if(f._sn)f._sn=\"og.\"+f._sn;for(var m in f){h.push(\"&\");h.push(g(m));h.push(\"=\");h.push(g(f[m]))}h.push(\"&emsg=\");h.push(g(e.name+\":\"+e.message));var j=h.join(\"\");if(H(j))j=j.substr(0,2E3);c=j;var k=window.gbar.logger._aem(a,"
                ...
                + "if(_tvv(\"1\")){var Pa=_tvb(\"true\",i);w.push([\"gc\",{auto:Pa,url:\"https://ssl.gstatic.com/gb/js/gcm_b83996bbc33bcd01855a9e817615014a.js\"}]);var Qa={version:\"gcm_b83996bbc33bcd01855a9e817615014a.js\",index:\"0\",lang:\"" + locale.getLanguage() + "\"};v.gc=Qa;var X=function(a){if(window.googleapis)a&&a();else{a&&D(a);C(\"gc\")}};n(\"lGC\",X);_tvv(\"1\")&&n(\"lPWF\",X)}"
                ...
                + "1;g<h;++g)f=f[c[g]]=f[c[g]]||{};return f[c[g]]=e};Va(Y,\"pw.clk\");Va(Y,\"pw.hvr\");n(\"su\",Sa,l.pw)}var Wa=function(a){y(\"uf\",a)};w.push([\"uf\",{url:\"//ssl.gstatic.com/gb/js/fm_e6150f2ae3471582f5e836c0e2ecbb3e.js\"}]);var Z={};Z.j=function(a){l.feedback.ds=a};Z.k=function(){Wa(function(){l.feedback.startFeedback()});C(\"uf\")};n(\"feedback\",Z);n(\"startFeedback\",Z.k,Z);n(\"dsc\",Z.j,Z);var Xa={productId:\"sandbar:119\",locale:\"" + locale.getLanguage() + "\"};v.feedback=Xa;"
                + "if(_tvv(\"\")){var $={},Ya=function(a,b){$[a]||($[a]=[]);$[a].push(b)},Za=function(a){if(a.type)for(var b=$[a.type],c=0;b&&c<b.length;++c)try{b[c](a)}catch(e){o(e)}};n(\"bc\",{subscribe:Ya,dispatch:Za})}var $a={w:1,A:2,O:3,o:4,N:5,D:6,i:7,F:8,S:9,M:10,C:11,L:12,K:13,G:14,J:15,I:16,Q:17,v:18,H:19,R:20,P:21,u:22,z:23,U:24,V:25,T:26,a:27,B:500},ab=_tvf(\"0.001\",1.0E-4),La=$a;"
                + "function bb(a,b){var c=encodeURIComponent,e=[\"//www.google.com/gen_204?atyp=i&zx=\",(new Date).getTime(),\"&oge=\",a,\"&ogex=\",c(\"30315\"),\"&ogp=\",c(\"119\"),\"&ogsr=\",Math.round(1/ab),\"&ogv=\",c(\"1314760973.1314123632\")];if(b){if(\"ogw\"in b){e.push(\"&ogw=\"+b.ogw);delete b.ogw}var f;f=b;var g=[],h;for(h in f){g.length!=0&&g.push(\",\");g.push(h);g.push(\".\");g.push(f[h])}f=g.join(\"\");if(f!=\"\"){e.push(\"&ogad=\");e.push(c(f))}}t(e.join(\"\"))}"
                + "if(_tvv(\"1\")&&Math.random()<ab){p=bb;n(\"il\",p,u);var cb={};v.il=cb}if(_tvv(\"1\")||_tvv(\"1\")){var db={uo:\"\",s:\"/\",h:\"/\",po:\"\",pa:\"/u/" + user.getNumber() + "/_/notifications/frame\",q:\"\",f:\"pid=119\",ipd:_tvn(\"5\",5),psec:_tvn(\"\",-1),it:_tvn(\"60\",-1),l:\"" + locale.getLanguage() + "\",sto:_tvn(\"10\",10),mnr:_tvn(\"30\",0),co:_tvv(\"\")};v.sw=db}"
            ...
            opera.removeEventListener("BeforeScript", injectJs, false);
            opera.postError("[Google+ Injector] injectJs(): Injected JavaScript and then removed event listener.");
        }
    };
    ...
    var injectCssAndHtml = function ()
    {
        ...
        topWindow.removeEventListener("DOMContentLoaded", injectCssAndHtml, false);
        opera.postError("[Google+ Injector] injectCssAndHtml(): Injected CSS and HTML and then removed event listener.");
    };

    topWindow.addEventListener("DOMContentLoaded", injectCssAndHtml, false);

    opera.addEventListener("BeforeScript", injectJs, false);
