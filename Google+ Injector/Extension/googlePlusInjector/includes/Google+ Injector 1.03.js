...
(function ()
{
    ...
    if (window.self === window.top) // Only add event listeners to the top-level window.
    {
        ...
        var getAvatarLink = function ()
        {
            handleException(function ()
            {
                avatarLink = window.top.OZ_initData["2"][1][3] + "?sz=48"; // Get the avatar link from the data arrays and then limit avatar size to 48x48 pixels.
            });
        };

        var getNotificationAndShareText = function ()
        {
            handleException(function ()
            {
                notificationText = window.top.document.selectNodes("//a[@href=\"/notifications/all\" and @class=\"d-h a-b-h-Jb a-la-h a-la-hA\"]")[0].innerHTML; // Get notification text from the left sidebar link.
            });

            handleException(function ()
            {
                shareText = window.top.document.selectNodes("//span[@role=\"button\" and @class=\"d-h a-b-f-i-Zd-h\"]")[0].innerHTML; // Get share text from the share links on the posts of the stream.
            });

            //window.opera.postError("Notifications: " + notificationText + "; Share: " + shareText);
        };
        ...
        var injectHtml = function ()
        {
            ...
            getNotificationAndShareText();

            var webToolbarButtonsHtml = "<li class=\"gbt gbtb\"><span class=gbts></span></li><li class=gbt><a class=\"gbgt gbgtd\" id=gbg1 href=\"/u/0/notifications/all\" title=\"" + notificationText + "\" onclick=\"gbar.tg(event,this)\" aria-haspopup=true aria-owns=gbd1><span class=gbtb2></span><span id=gbgs1 class=gbts><span id=gbi1a class=gbid></span><span id=gbi1 class=gbids>&nbsp;</span></span></a><div id=gbd1 class=\"gbm gbmsgo\" aria-owner=gbg1><div class=gbmc></div><div class=gbmsg></div></div></li><li class=\"gbt gbtb\"><span class=gbts></span></li><li class=gbt><a class=gbgt id=gbg3 href=\"/u/0/stream/all\" onclick=\"gbar.tg(event,this)\" aria-haspopup=true aria-owns=gbd3><span class=gbtb2></span><span id=gbgs3 class=gbts><div class=gbgsc><span class=gbgsb><span id=gbi3 class=gbgst>" + shareText + "&hellip;</span><span class=gbgsta>" + shareText + "</span></span><span class=gbgss>" + shareText + "&hellip;</span><span class=gbgsca></span><span class=gbgscb></span></div></span></a><div class=\"gbm gbmsgo\" id=gbd3 aria-owner=gbg3><div class=gbmc></div><div class=gbmsg></div></div></li><li class=\"gbt gbtb\"><span class=gbts></span></li><li class=gbt><a class=\"gbgt gbg4a\" id=gbg4 href=\"//google.com/profiles\" onclick=\"gbar.tg(event,this)\" aria-haspopup=true aria-owns=gbd4><span class=gbtb2></span><span id=gbgs4 class=gbts><span id=gbi4><span class=gbi4p></span><span id=gbi4id style=\"display:none\"></span><img id=gbi4i width=24 height=24 onerror=\"window.gbar&&gbar.pge?gbar.pge():this.loadError=1;\" src=\"" + avatarLink + " \" alt=\"\"></span></span></a>";
        ...
        var injectJs = function (event)
        {
            if ((event.element.text.length >= 8000 && event.element.text.length <= 9000) && event.element.text.indexOf("window.jstiming.load.tick('ogjl');") !== -1)
            {
                ...
                handleException(function ()
                {
                    language = languageRegex.exec(event.element.text)[1];
                });

                var userDataRegex = /var Pa={(.+?)};/g;
                var userData = null;

                handleException(function ()
                {
                    userData = userDataRegex.exec(event.element.text)[1];
                });
                ...
                var js = "(function(){try{var d=true,i=false;var l=window.gbar=window.gbar||{};function _tvn(a,b){var c=parseInt(a,10);return isNaN(c)?b:c}function _tvf(a,b){var c=parseFloat(a);return isNaN(c)?b:c}function _tvb(a,b){return a==\"true\"?d:a==\"false\"?i:b}function _tvv(a){return!!a}function n(a,b,c){(c||l)[a]=b}l.bv={n:_tvn(\"2\",0),r:\"\",m:_tvn(\"1\",1)};var aa=function(){return l.bv.m==1};n(\"sb\",aa);"
                    ...
                    + "1;g<h;++g)f=f[c[g]]=f[c[g]]||{};return f[c[g]]=e};Qa(Y,\"pw.clk\");Qa(Y,\"pw.hvr\");n(\"su\",Na,l.pw)}var Ra=function(a){y(\"uf\",a)};w.push([\"uf\",{url:\"//ssl.gstatic.com/gb/js/fm_e6150f2ae3471582f5e836c0e2ecbb3e.js\"}]);var Z={};Z.a=function(a){l.feedback.ds=a};Z.i=function(){Ra(function(){l.feedback.startFeedback()});C(\"uf\")};n(\"feedback\",Z);n(\"startFeedback\",Z.i,Z);n(\"dsc\",Z.a,Z);var Sa={productId:\"sandbar:119\",locale:\"" + language + "\"};u.feedback=Sa;"
                    ...
                    + "if(_tvv(\"1\")&&Math.random()<Va){p=Wa;n(\"il\",p,t);var Xa={};u.il=Xa}if(_tvv(\"1\")||_tvv(\"1\")){var Ya={uo:\"\",s:\"/\",h:\"/\",po:\"\",pa:\"/u/0/_/notifications/frame\",q:\"\",f:\"pid=119\",ipd:_tvn(\"5\",5),psec:_tvn(\"\",-1),it:_tvn(\"60\",-1),l:\"" + language + "\",sto:_tvn(\"10\",10),mnr:_tvn(\"30\",0)};u.sw=Ya}"
                    + "if(_tvv(\"1\")){var Za=[],$a=function(a){Za.push(a)};n(\"nuc\",Za);n(\"anuc\",$a);var ab={ht:_tvn(\"100\",0),n:\"" + notificationText + "\"};u.no=ab}if(_tvv(\"1\")){var bb=[],cb=function(a){bb.push(a)};n(\"smc\",bb);n(\"asmc\",cb);var db={ht:_tvn(\"100\",0),n:\"" + shareText + "\"};u.sb=db}var eb=function(){l.prm&&l.prm()},fb=function(a){y(\"m\",function(){l.spn(a)})},gb=function(a){y(\"m\",function(){l.spp(a)})};n(\"spn\",fb);n(\"spp\",gb);"
                    + "xa(\"gbd4\",eb);if(_tvb(\"true\",d)){var hb={" + userData + "};u.prf=hb}"
